  ...
  return (
    ...
    pt-20 pb-30' >
        <div className='flex flex-col md:flex-row items-center justify-between w-full' >
            <Title align='left' title='Exclusive Offers' subtitle='Take advantages 
            of our limited-time offers and special packages to enhance your stay and 
        ...
        {exclusiveOffers.map((item)=> (
            ...
            bg-no-respect bg-cover bg-center ' style={{backgroundImage: `url(${item.image})`}}>
