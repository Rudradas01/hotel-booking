...
const AllRooms = () => {
    ...
    const filterDestination = (room) =>{
        ...
        return room.hotel && room.hotel.city && room.hotel.city.toLowerCase().includes(destination.toLowerCase())
    }
        ...
        border-b border-gray-300 last:pb-30 last-border-0' >
            ...
            <div className='md:w-1/2 flex flex-col gap-2' >
                ...
                {room.amenities.map((item, index)=> (
                    ...
                    py-3 py-2 rounded-lg bg-[#F5F5FF]/70' >
    ...
    <div className={`${openFilters ? 'h-auto' : "h-0 lg:h-auto"}
     ...
     <div className='px-5 pt-5' >
        ...
        {roomTypes.map((room, index)=> (
            ...
            onChange={(checked)=>handlerFilterChange(checked, room, 'roomType')} />
        ))}
     </div>
     ...
     <div className='px-5 pt-5 pb-7' >
        ...
        {sortOptions.map((option, index)=> (
            ...
            === option } onChange={()=> handlerSortChange(option)} />
        ))}
     </div>
