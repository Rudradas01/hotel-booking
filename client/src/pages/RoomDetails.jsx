...
const RoomDetails = () => {
    ...
    // on submitHandler function to check availability & book the room
  ...
  return room && (
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'  >
        <p>
            ...
            guest to get the exact price for groups. The Guest will be allocated 
            ground floor according to Availability. You get the comfortable two 
